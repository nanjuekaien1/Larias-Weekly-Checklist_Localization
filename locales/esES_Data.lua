...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "11425027", text = "Nota: Solo el abalorios de renombre de campeón de Singularidad Y Canción Eterna están disponibles en el acceso anticipado - los demás estarán disponibles el lunes después del lanzamiento oficial o tras el reinicio semanal de cada región." }, -- ⚠️ UNVERIFIED
            { id = "34624ba9", text = "Actualización de Emergencia del 2 de Marzo" },
            { id = "2c77c3c4", text = "Completa la Velada de Saltheril semanal en Bosque Canción Eterna. ¡ACABA DE ABRIRSE, TIENES QUE COMPLETARLA ANTES DEL REINICIO SEMANAL! No olvides recoger la misión de renombre para el yelmo de campeón si tienes el renombre" }, -- ⚠️ UNVERIFIED
        },
    },

...
local STRINGS = {
    ...
    TRACKING_SPARKS_LABEL = "Flujo de maná albaluz:",
    TRACKING_DONE = "Hecho",
    ...
    TRACKING_CONVERT_TOOLTIP = "Número de crestalboradas que ganarás al convertir crestalboradas anteriores",
    ...
    OPTIONS_HIDE_COMPLETED_TASKS = "Ocultar tareas completadas",
    HIDE_FINISHED_WEEKS = "Ocultar semanas completadas",
    ...
    SETTINGS_LANGUAGE_AUTO = "Auto (predeterminado del cliente)",
    UPGRADE_WARN_MSG = "Mejorar un objeto %s 1/6 es un desperdicio de %d crestalboradas.\nDeberías mejorar un objeto %s 5/6 en su lugar", -- ⚠️ UNVERIFIED
    ...
    COPY_LINK_POPUP_TEXT     = "Presiona |cffffffffCtrl+C|r para copiar:", -- ⚠️ UNVERIFIED
